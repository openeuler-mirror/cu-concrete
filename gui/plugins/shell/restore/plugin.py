...
class RestorePlugin(GuiPlugin):
    def create_widget(self, parent):
        ...
        def run_selected(selected):
            ...
            return text
        return ActionPanel("还原", "选择策略项并执行还原（经 PolicyAdapter 转调 rollback）", names, lambda n: "", run_selected, self.context)
