# -*- coding: utf-8 -*-
"""插件入口: policy.LockingInvalidAccount_2"""
...
class Policy_LockingInvalidAccount_2_Plugin(GuiPlugin):
    POLICY_NAME = "LockingInvalidAccount_2"
    ...
    def create_widget(self, parent):
        return PolicyDetailPanel(
            ...
            department=int(self.meta.department or 1),
