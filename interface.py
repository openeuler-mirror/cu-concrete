...
# from checklist import sub_checklist
# from rollbacklist import sub_rollbacklist
...
def text_box():
    ...
    try:
        ...
        # 可以根据 success 判断用户是否点击 OK，但通常不需要
...
def setup_logging(log_dir="logs", log_file="app.log", level=logging.INFO):
    ...
    current_dir = os.path.dirname(os.path.abspath(__file__))  # config/ 目录
    project_root = os.path.dirname(current_dir)              # 上一级，即项目根目录
