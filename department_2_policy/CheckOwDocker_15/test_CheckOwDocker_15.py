...
def load_module():
    ...
    spec = importlib.util.spec_from_file_location('CheckOwDocker_15_module', module_path)
...
backup_path = '/tmp/test_checkowdocker_bak'
...
def build_instance():
    mod = load_module()
    cls = getattr(mod, 'CheckOwDocker_15')
    obj = cls()
    obj.config_file = '/tmp/CheckOwDocker_15.yaml'
